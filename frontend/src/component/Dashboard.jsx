...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <header className="border-b bg-white"><div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4"><div><h1 className="text-xl font-bold">CareBridge Admin</h1><p className="text-xs text-slate-500">Aggregated wellbeing support overview</p></div><div className="flex items-center gap-2"><ThemeToggle /><button onClick={() => navigate("/")} className="rounded-lg px-3 py-2 text-sm text-slate-600 hover:bg-slate-100">Resident portal</button><button onClick={logout} className="rounded-lg px-3 py-2 text-sm text-slate-600 hover:bg-slate-100">Log out</button></div></div></header>
